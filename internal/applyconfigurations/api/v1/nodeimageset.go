...
// apply.
func NodeImageSet(name string) *NodeImageSetApplyConfiguration {
	b := &NodeImageSetApplyConfiguration{}
	b.WithName(name)
	b.WithKind("NodeImageSet")
...
func (b *NodeImageSetApplyConfiguration) WithSpec(value *NodeImageSetSpecApplyConfiguration) *NodeImageSetApplyConfiguration {
	b.Spec = value
	return b
}
...
func (b *NodeImageSetApplyConfiguration) WithStatus(value *NodeImageSetStatusApplyConfiguration) *NodeImageSetApplyConfiguration {
	b.Status = value
	return b
}
